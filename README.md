...
It exists a SaToSa distribution pre-configured for facilitating the integration
with the Italian National Digital Identity Systems,
this is [Satosa-Saml2Spid](https://github.com/italia/Satosa-Saml2Spid).
