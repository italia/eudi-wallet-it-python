...
class OpenIDVP4SAMLBackend(SAMLBackend):
    """
    ...
    def qrCode_endpoint(self, context, *args):
        return Response(
            text_type(
                base64.encode('eudiw://authorize?client_id=https://verifier.example.org&request_uri=https://verifier.example.org/request_uri')
