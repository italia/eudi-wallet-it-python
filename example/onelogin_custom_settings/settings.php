...
$posible_nameidformat_values = array(
    ...
    'uri' => 'urn:oasis:names:tc:SAML:2.0:attrname-format:uri'    #ITWallet: add uri name format
);
...
$settings = array (
    ...
    'sp' => array (
        ...
        #ITWallet: Adding the attributeConsumingService section in the metadata
        'attributeConsumingService' => array (
            'serviceName' => (!empty($opt['sp_entity_id'])? $opt['sp_entity_id'] : 'php-saml'),
    ...
    'security' => array (
        'signMetadata' => true, #ITWallet: enables metadata signature
