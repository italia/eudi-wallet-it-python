...
| Key                                         | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|---------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| config.security.dpop_required               | When true, DPoP validation is required at token and credential endpoints and access/refresh tokens are bound to the DPoP key (RFC 9449). When false or missing (default), DPoP is optional and tokens are not DPoP-bound.                                                                                                                                                                                                                                           |
