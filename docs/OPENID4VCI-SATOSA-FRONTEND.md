...
| config.security.wallet_attestation_required | This is the flag to enable the wallet client attestation validation in POP JWT format<br />([https://www.ietf.org/archive/id/draft-ietf-oauth-attestation-based-client-auth-06.html#section-5.2](https://www.ietf.org/archive/id/draft-ietf-oauth-attestation-based-client-auth-06.html#section-5.2)).<br />If this setting is missing it will be set to true by default. |
