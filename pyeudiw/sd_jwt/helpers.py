# DEVELOPER NOTE: the code in this file used to belong to in sd_jwt/__init__.py
# Since then, it has been removed with PR 308, but unit test that relied on this code
#   has not been ported yet. As such, we should either re-do the test according to
#   the changes in PR 308 OR re-introduce thiss code somewhere appropriate.
# As a temporary solution, I am copy-pasting the old code as it appeared in commit 5c3c95ea1918aedbea140bc675bfedc9732bac97
...
from pyeudiw.jwt import DEFAULT_SIGN_KTY_TO_ALG
...
class TrustChainSDJWTIssuer(SDJWTIssuer):
    ...
    def __init__(
        ...
        sign_alg = sign_alg if sign_alg else DEFAULT_SIGN_KTY_TO_ALG[issuer_key.kty]
