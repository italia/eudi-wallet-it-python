...
def _decode_jwt_status_list_token(token: str) -> tuple[dict, dict, int, bytes]:
    """
    ...
    :return: A tuple containing the header, payload, bits, and status list.
    ...
    return header, payload, bits, status_list

def _decode_cwt_status_list_token(token: bytes) -> tuple[dict, dict, int, bytes]:
    """
