...
from pyeudiw.x509.verify import verify_x509_attestation_chain, verify_x509_anchor
...
def test_anchor_valid_chain_invalid_date():
    ...
    assert verify_x509_anchor(pem, datetime.fromisoformat('2014-12-04')) == False
