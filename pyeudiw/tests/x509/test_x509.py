...
def test_valid_chain():
    chain = gen_chain()
    assert verify_x509_cert_chain(chain, datetime.fromisoformat('2050-12-04')) == True

def test_valid_chain_invalid_date():
    chain = gen_chain()
    assert verify_x509_cert_chain(chain, datetime.fromisoformat('2014-12-04')) == False
...
def test_invalid_intermediary_chain():
    ...
    assert verify_x509_cert_chain(chain, datetime.fromisoformat('2050-12-04')) == False
