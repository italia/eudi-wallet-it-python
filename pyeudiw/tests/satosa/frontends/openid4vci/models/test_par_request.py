...
def test_invalid_aud(value):
    payload = {"iss": "client-123", "aud": value}
...
def test_empty_or_missing_state(value):
    payload = {"iss": "client-123", "aud": "entity-123"}
    if value is not None:
        payload["state"] = value
...
def test_invalid_state(value):
    payload = {"iss": "client-123", "aud": "entity-123", "state": value}
...
def test_empty_or_missing_client_id(value):
    payload = {"iss": "client-123", "aud": "entity-123", "state": "A" * 32}
    if value is not None:
