...
def test_parse_key_from_x5c():
    ...
    obt_key = parse_key_from_x5c(x5c_rsa).as_dict()
    ...
    obt_key = parse_key_from_x5c(x5c_ec).as_dict()
    ...
    try:
        parse_key_from_x5c(x5c_invalid)
        assert False
    except Exception as e:
        assert isinstance(e, InvalidJwk)
        assert str(e) == "unable to parse key from x5c: ['invalid_x5c']"