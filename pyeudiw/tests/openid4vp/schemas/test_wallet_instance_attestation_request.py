...
from pyeudiw.openid4vp.schemas.wallet_instance_attestation_request import WalletInstanceAttestationRequestHeader, \
...
def test_header():
    ...
    with pytest.raises(ValidationError):
        WalletInstanceAttestationRequestHeader.model_validate(
            WALLET_INSTANCE_ATTESTATION_REQUEST['header'], context={"supported_algorithms": ["RS128", "ES128"]})
    WalletInstanceAttestationRequestHeader.model_validate(
        WALLET_INSTANCE_ATTESTATION_REQUEST['header'], context={"supported_algorithms": ["RS256", "ES256"]})
