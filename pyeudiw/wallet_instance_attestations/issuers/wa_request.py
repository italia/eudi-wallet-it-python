...
from pyeudiw.wallet_instance_attestations import (WalletInstanceAttestationRequestHeader,
...
class WaJswRequestIssuer(BaseJwsIssuer):
    ...
    def _get_jwt_payload(self) -> dict:
        ...
        claims["iss"] = self._issuer + self._generate_jwk_thumbprint(self._hardware_pubkey) #replace default
